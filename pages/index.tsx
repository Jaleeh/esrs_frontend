...
const Home: NextPage = () => {
  ...
  const [active, setactive] = useState("vig");
  ...
  const handleClick = () => {
    dispatch({
      type: ActionKind.CEASAR,
      payload: { cipher: "no", subcipher: "yes" },
    });
  };
  ...
  return (
    <div className="bg-green-400 min-h-screen p-2">
      ...
      <div>
        ...
        <div className="  flex justify-center">
          ...
          <div className="max-w-3xl space-x-5 text-sm flex justify-between">
            <button className="font-bold text-blue-500" onClick={handleVig}>
              VIGENERE CIPHER
            </button>
            <button
              id="jason"
            ...
            <button className="font-bold text-blue-500" onClick={handleOne}>
              {" "}
              ONE TIME PAD
            </button>
          </div>
      ...
      <div className="border-2 h-[500px] p-4 mt-10 mr-8 ml-8 border-black ">
        <div className="mt-5">
          <Vigenere active={active} type="encrypt" />
        </div>
        <div className="mt-5">
          <Caesar active={active} type="" />
        </div>
        <div className="mt-5">
