...
import Elgamalkeygen from "../components/Elgamalkeygen";

const Pubgen: NextPage = () => {
  ...
  return (
    <div className="bg-green-400 min-h-screen p-2">
      ...
      <div>
        ...
        <div className="  flex justify-center">
          ...
          <div className="max-w-3xl space-x-5 text-sm flex justify-between">
            <button className="font-bold text-blue-500" onClick={handleRsa}>
              RSA
            </button>
            <button
              id="jason"
      ...
      <div className="border-2 h-[500px] p-4 mt-10 mr-8 ml-8 border-black ">
        <div className="mt-5">
          <Rsa active={active} type="encrypt" />
        </div>
        <div className="mt-5">
          <Elgamalkeygen active={active} type="" />
        </div>
      </div>
    </div>
  );
